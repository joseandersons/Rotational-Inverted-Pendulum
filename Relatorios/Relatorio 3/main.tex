...
\begin{itemize}
    ...
    \item \textbf{Resposta à Rampa} Foi obtida ao fornecer uma pertubação crescente.
...
Esta imagem (arquivo: \texttt{degrau\_malha\_aberta.jpg}) corresponde à \textbf{resposta ao degrau}.
\begin{itemize}
...
\paragraph{Observações:}
Esta imagem (arquivo: \texttt{rampa\_malha\_aberta.jpg}) corresponde à \textbf{resposta à rampa}.
\begin{itemize}
